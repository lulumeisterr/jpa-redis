...
public class ClientesController {
	...
	@PostMapping("/cliente")
	public ResponseEntity<Void> addCliente(@RequestBody ClientePresenter cliente, UriComponentsBuilder builder) {
	...
	@GetMapping()
	public ResponseEntity<List<ClientePresenter>> getAllProdutos() {
	...
	@PutMapping("/cliente")
	public ResponseEntity<ClientePresenter> updateProduto(@RequestBody ClientePresenter cliente) {
